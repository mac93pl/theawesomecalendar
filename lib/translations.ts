...
export const COPY = {
  pl: {
    ...
    nav: { how: 'Jak to działa', variants: 'Warianty', support: 'Wspieram' },
    hero: {
      ...
      riceButton: 'Pobierz {year} rok - ryż',
      blockButton: 'Pobierz {year} rok - kolumny',
      nextYearButton: 'Pobierz {year}',
      clickToDownload: 'Kliknij i pobierz {year}',
    },
    projectNote: {
    ...
    donation: {
      ...
      legal: 'Wpłata oznacza darowiznę na wsparcie i rozwój projektu. Wszystkie funkcje storny są dostępne za darmo, i nie wymagają dodatkowych opłat. Dzięki za wsparcie!',
      status: {
  ...
  en: {
    ...
    nav: { how: 'How it works', variants: 'Styles', support: 'Support' },
    hero: {
      ...
      nextYearButton: 'Download {year}',
      clickToDownload: 'Click to download {year}',
    },
    projectNote: {
